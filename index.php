...
<meta name="keywords" content="клан, танки, танки онлайн, вот, emulator, debugger, windows, linux, macos, freebsd, open source, nekotekina, kd11, home">
		...
		<div class="content-con-outside">
			<div class="content-con-inside">
				...
				<div class='landing-con-right content-remove '>
					<div class='landing-img-hero' style="background: url(/img/graphics/landing/object-703v2_insha.png) no-repeat center; background-size: contain;">
					</div>
				</div>
			</div>
		</div>
				...
				<div class="discord-con-container">
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							...
							<a href="https://discord.gg/4XUqzjrcTC" target="_blank">
